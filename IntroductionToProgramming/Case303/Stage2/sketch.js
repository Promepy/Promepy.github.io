...
{
	cryptic_storage_keyE =constrain(mouseY,17, 75);

}
function mousePressed()
{
	cryptic_storage_keyB = constrain(cryptic_storage_keyB - 2, 3, 17);
}
function mouseReleased()
{
	cryptic_storage_keyA = max(mouseY, 3);
	cryptic_storage_keyC = min(mouseX, 17);
}
function keyPressed()
{
	cryptic_storage_keyD = min(cryptic_storage_keyD+1, 15);
}
