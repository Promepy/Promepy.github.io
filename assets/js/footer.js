      ...
      '<div class="container">' +
        '<div class="footer-grid">' +
          '<div class="footer-col">' +
            "<h4>Gowtham M.</h4>" +
            "<p>High-performance portfolio presentation for web platforms, automation systems, and private AI delivery.</p>" +
          ...
          '<div class="footer-col">' +
            "<h4>Other</h4>" +
            '<a href="' + toHref(root, "Resume/index.html") + '">Resume</a>' +
        ...
        '<div class="footer-bottom">' +
          ...
          "<p>Built with cinematic restraint and conversion intent.</p>" +
        "</div>" +
      "</div>";
